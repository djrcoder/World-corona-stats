...
export default function SimpleMap() {
  ...
  // "x-rapidapi-key": process.env.REACT_APP_CORONA
  //   }
  // })
  //   .then(response => {
  //     response.data.countries_stat.map(country => {
  //       console.log('country :', country);
  //       countriesNames.push(country.country_name);
  //     })
  ...
  //           })
  //             .then(response => {
  //               allCountries.push(response.data.results[0].geometry.location);
  //             })
  //             .catch(error => {
  //               console.log(error);
  //             });
